...
<table width="1200px" cellspacing="0" cellpadding="0" >
 ...
 <td width="378.5px">
  ...
  <td align = "center" valign="center" colspan="2">
   <table width="443px" cellspacing="0" cellpadding="0" style="margin:0;" border="1" rules="none" bordercolor="#fffb8b">
    ...
    <tr>
     <td align = "center">
      <span style="font-size:14px;"><b>Q<span style="font-size:12px;">&</span>A</b></span></td>
    </tr>
    <tr>
     <td height="30px"></td>
    </tr>
 ...
 <td width="290px">
  ...
  <td align="right" valign="top" bgcolor="#fffb8b">
	<a href="#" id ="update"><img src="../images/updateMember.gif"></a><a href="memberDelForm" id ="memberDel"><img src="../images/signout2.gif"></a>
  </td>
 <td width="378.5px">
 </td>
 </tr>
